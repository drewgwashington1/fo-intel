    ...
    <template v-else-if="summary">
      ...
      <div v-if="filteredInsights.length" class="space-y-3">
        <div
          ...
          :key="insight.id"
          class="bg-surface-card rounded-xl border border-surface-border p-5 border-l-4 transition-colors hover:bg-surface-hover overflow-hidden"
        ...
        >
          <div class="flex items-start gap-4">
            ...
            <div class="flex-1 min-w-0">
              ...
              <h3 class="text-sm font-semibold text-gray-900 mb-1 break-words">{{ insight.title }}</h3>
              <p class="text-xs text-gray-500 leading-relaxed mb-3 break-words">{{ insight.description }}</p>
              ...
              <div class="flex items-start gap-2 bg-gray-50 rounded-lg px-3 py-2">
                ...
                <p class="text-xs text-gray-500 break-words">{{ insight.action }}</p>
              </div>
